    ...
    return (
        <header>
            ...
            <div className="banner-text">
                <h2 className="banner-text-heading">Get Yourself The Best Bots in The Bizz</h2>
                <p className="banner-text-body">With our bots you don't have to spend every waking hour watching your charts
